    ...
    <Card className="w-full max-w-md mx-auto dark:bg-slate-900 dark:border-slate-800 dark:shadow-none shadow-xl shadow-slate-200/50 rounded-[2.5rem] border-slate-100 overflow-hidden">
      <CardHeader className="space-y-2 p-10 pb-6">
        ...
        <CardDescription className="text-center text-sm text-slate-500">
          Inisialisasi Ekosistem Toko Baru
        </CardDescription>
      </CardHeader>
      <form onSubmit={handleSubmit}>
        <CardContent className="space-y-5 px-10">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-slate-700 dark:text-slate-300 ml-1" htmlFor="storeName">Nama Toko</label>
            <Input 
              id="storeName" 
              name="storeName" 
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-slate-700 dark:text-slate-300 ml-1" htmlFor="name">Username Admin</label>
            <Input 
              id="name" 
              name="name" 
